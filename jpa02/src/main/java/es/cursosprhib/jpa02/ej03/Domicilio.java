...
public class Domicilio implements Serializable {
	...
	//@Column (name = "tipovia") no se debe. mejor hacer un override en la tabla principal donde se mete el domicilio, osea en Persona
	private String tipoVia;
	private String via;
	private int numero;
	private int piso;
	private String puerta;
	//@Column (name = "codigopostal") no se debe. mejor hacer un override en la tabla principal donde se mete el domicilio, osea en Persona
